...
class LessonTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.course = Course.objects.create(title='Курс 3', description='Это третий курс')
...
class CourseTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.user = User.objects.create(email='test@test.com')
        self.course = Course.objects.create(title='Курс 5', description='Это пятый курс', owner=self.user)
        self.client.force_authenticate(user=self.user)
